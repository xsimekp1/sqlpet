...
export const COMMANDS: Command[] = [
  ...
  },
  {
    ...
    icon: 'User',
    keywords: ['profil', 'fotka', 'avatar', 'osobni', 'ucet', 'fotografie', 'telefon'],
    keywordsEn: ['profile', 'photo', 'avatar', 'personal', 'account', 'picture', 'phone'],
    tags: ['settings'],
  },
  {
    id: 'settings.profile.phone',
    title: 'Změnit telefon',
    titleEn: 'Change Phone',
    description: 'Změnit telefonní číslo v profilu',
    descriptionEn: 'Change phone number in profile',
    href: '/dashboard/settings/profile',
    icon: 'Phone',
    keywords: ['telefon', 'cislo', 'mobil', 'zmena'],
    keywordsEn: ['phone', 'number', 'mobile', 'change'],
    tags: ['settings'],
  },
]
